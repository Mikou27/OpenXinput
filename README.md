...
For a free to use Windows Xinput like library, you can take a look at my gamepad library here or switch to the new [Windows Gaming Input (WGI) APIs](https://learn.microsoft.com/en-us/uwp/api/windows.gaming.input):
[gamepad](https://github.com/Nemirtingas/gamepad/blob/d4dd203c6bce54521ac73e8d8fd7653ed2056850/src/gamepad.cpp#L354-L714)